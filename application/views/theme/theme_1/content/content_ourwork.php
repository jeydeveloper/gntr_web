				...
				<div class="tg-service-img tg-haslayout">
					<div class="tab-content tg-img-border">
						...
						<div role="tabpanel" class="tab-pane fade" id="portfolio-item-two">
							<figure>
								<a href="<?php echo $assets['images']; ?>/portfolio/img-15.jpg" data-rel="prettyPhoto[gallery1]">
									<img src="<?php echo $assets['images']; ?>/portfolio/img-15.jpg" alt="image description">
								</a>
							</figure>
						</div>
						<div role="tabpanel" class="tab-pane fade" id="portfolio-item-three">
							<figure>
								<a href="<?php echo $assets['images']; ?>/portfolio/img-16.jpg" data-rel="prettyPhoto[gallery1]">
									<img src="<?php echo $assets['images']; ?>/portfolio/img-16.jpg" alt="image description">
								</a>
							</figure>
						</div>
						<div role="tabpanel" class="tab-pane fade" id="portfolio-item-four">
							<figure>
								<a href="<?php echo $assets['images']; ?>/portfolio/img-17.jpg" data-rel="prettyPhoto[gallery1]">
									<img src="<?php echo $assets['images']; ?>/portfolio/img-17.jpg" alt="image description">
								</a>
							</figure>
						</div>
						<div role="tabpanel" class="tab-pane fade in" id="portfolio-item-five">
							<figure>
								<a href="<?php echo $assets['images']; ?>/portfolio/img-18.jpg" data-rel="prettyPhoto[gallery1]">
									<img src="<?php echo $assets['images']; ?>/portfolio/img-18.jpg" alt="image description">
								</a>
							</figure>
						</div>
						<div role="tabpanel" class="tab-pane fade" id="portfolio-item-six">
							<figure>
								<a href="<?php echo $assets['images']; ?>/portfolio/img-19.jpg" data-rel="prettyPhoto[gallery1]">
									<img src="<?php echo $assets['images']; ?>/portfolio/img-19.jpg" alt="image description">
								</a>
							</figure>
						</div>
						<div role="tabpanel" class="tab-pane fade" id="portfolio-item-seven">
							<figure>
								<a href="<?php echo $assets['images']; ?>/portfolio/img-20.jpg" data-rel="prettyPhoto[gallery1]">
									<img src="<?php echo $assets['images']; ?>/portfolio/img-20.jpg" alt="image description">
								</a>
							</figure>
						</div>
						<div role="tabpanel" class="tab-pane fade" id="portfolio-item-eight">
							<figure>
								<a href="<?php echo $assets['images']; ?>/portfolio/img-21.jpg" data-rel="prettyPhoto[gallery1]">
									<img src="<?php echo $assets['images']; ?>/portfolio/img-21.jpg" alt="image description">
								</a>
							</figure>
						</div>
					</div>
