				...
				<div class="tg-cols">
					<div class="col-sm-6 tg-colfirst-bgcolor">
						<div class="tg-col">
							...
							<strong class="logo">
								<a href="index.html">
									<img src="<?php echo $assets['images']; ?>/logo2.png" alt="constructioner">
								</a>
							</strong>
